...
- (void)initCircles
{
    ...
    for (int i=0; i<9; i++) {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"gestures_small_w"] forState:UIControlStateNormal];
        [button setBackgroundImage:[UIImage imageNamed:@"gestures_small_g"] forState:UIControlStateSelected];
