...
//2013-02-26 05:59:42 +0000
- (NSString*)dateYear;      //return 2012
- (NSString*)dateMouth;     //return 2
- (NSString*)dateDay;       //return 26
- (NSString*)dateHour;      //return 5
- (NSString*)dateMinute;    //return 59
- (NSString*)dateSecond;    //return 42
@end
