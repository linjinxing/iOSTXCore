...
- (void)setup
{
    ...
    _drawingView.layer.borderWidth = 1;
    _drawingView.layer.borderColor = [UIColor lightGrayColor].CGColor;
    ...
    _pan = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"dot"]];
    _pan.hidden = YES;
    [_drawingView addSubview:_pan];
}
...
- (void)drawingViewDidPan:(UIPanGestureRecognizer*)sender
{
    ...
    _pan.origin = currentDraggingPosition;
    [_drawingView bringSubviewToFront:_pan];
