...
- (id)initWithPoints:(NSArray *)points
{
    ...
    if(self){
        ...
        double *dataX = (double *)malloc(sizeof(double) * _pointNum);
        double *dataY = (double *)malloc(sizeof(double) * _pointNum);
...
- (id)initWithData:(double*)data dataNum:(NSInteger)dataNum
{
    ...
    if(self){
        ...
        a = (double *)malloc(dataNum * sizeof(double));
        b = (double *)malloc(dataNum * sizeof(double));
        c = (double *)malloc(dataNum * sizeof(double));
        d = (double *)malloc(dataNum * sizeof(double));
        ...
        double *w = (double *)malloc(dataNum * sizeof(double));
        w[0]=0.0;
        for(NSInteger i=1; i<dataNum-1; ++i){
